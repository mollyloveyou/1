               ...
               thread_func *function, void *aux) 
{
  ...
  /*add by zhangyanjing for alarm-clock*/
  t->ticks_blocked = 0;
  /*add end*/
  ...
  /*add by sunjingling for Priority*/
...
thread_unblock (struct thread *t) 
{
  ...
  /*modify by sunjingling for Priority*/
...
thread_yield (void) 
{
  ...
  old_level = intr_disable ();
  if (cur != idle_thread) 
     /*modify by zhangyanjing for alarm-clock*/
